          ...
          embeds: [
            new EmbedBuilder()
              ...
              .addFields([
                ...
                {
                  name: `Author`,
                  iconURL:"https://cdn.discordapp.com/attachments/1216051387666927656/1216095437946228807/image-removebg-preview-removebg-preview.png?ex=65ff2422&is=65ecaf22&hm=3175d083ca9c55c2327d2c9a9d3437675eb2f56d12adf8747a8b33f19116e389&",
                  value: `\`${song.uploader.name}\``,
                  inline: true,
                },
                {
                  name: `Likes`,
                  value: `\`${song.likes.toLocaleString()}\``,
                  inline: true,
        ...
        .send({
          embeds: [
            new EmbedBuilder()
              ...
              .setAuthor({
                name: `Added to Queue`,
                iconURL: "https://cdn.discordapp.com/emojis/919242500173086751.gif?size=160&quality=lossless",
            ...
            .setFooter(client.getFooter(song.user)),
                  ...
                  .setColor(client.config.embed.color)
                    .setAuthor({
                      ...
                      iconURL: "https://cdn.discordapp.com/emojis/1205853447128350761.webp?size=160&quality=lossless",
                    })
                  ...
                  .setThumbnail(`https://media.discordapp.net/attachments/1216048602519179365/1216807154825035917/image_1.png?ex=6601baf8&is=65ef45f8&hm=41059d4c35f73f908acc74723c0b35da23317e26  9af18d8f19d559c8526aabb8&=&format=webp&quality=lossless&width=705&height=525`)
      ...
      queue.textChannel
        .send({
          embeds: [
            new EmbedBuilder()
              .setColor(client.config.embed.color)
              .setDescription(`Queue has ended! No more music to play ( لقد تم الانتهاء من الاغنيه الخاصه بك ) `),
          ],
        })
    });
