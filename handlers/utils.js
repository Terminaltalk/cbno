...
module.exports = async (client) => {
  ...
  client.queueembed = (guild) => {
    let embed = new EmbedBuilder()
      .setColor(client.config.embed.color)
      .setTitle(`Copyright © 2024 Cybeno`);
    ...
    let embed = new EmbedBuilder()
      ...
      .setImage(
        guild.banner
          ...
          : `https://media.discordapp.net/attachments/1215746415385645189/1215914643013500978/Cybeno.gif?ex=65fe7bc1&is=65ec06c1&hm=628151ea0c59927495a8a079fbbaee1870183fcb4eaea07e874778fa09afe66d&`
      )
      .setFooter({
        text: guild.name,
    ...
    queueembed.edit({
      embeds: [
        new EmbedBuilder()
          .setColor(client.config.embed.color)
          .setAuthor({
            name: `Copyright © 2024 Cybeno [  ${queue.songs.length} Tracks ]`,
            iconURL: guild.iconURL({ dynamic: true }),
          })
